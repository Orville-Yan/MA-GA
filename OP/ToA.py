...
class OP_BBD2A:
    ...
    def D_Minute_area_bifurcate_mean(m_tensor_x, m_tensor_y, mask):
        OP_AA2A.D_at_sub(OP_BD2A.D_Minute_area_mean(m_tensor_x, OP_BA2D.Mmask_day_plus(m_tensor_y,
                                                                                       OP_BD2A.D_Minute_area_mean(
                                                                                           m_tensor_y, mask))),
        OP_BD2A.D_Minute_area_mean(m_tensor_x,
                                   OP_BA2D.Mmask_day_sub(m_tensor_y, OP_BD2A.D_Minute_area_mean(m_tensor_y, mask))))
        pass

    @staticmethod
    def D_Minute_area_bifurcate_std(m_tensor_x, m_tensor_y, mask):
        OP_AA2A.D_at_sub(OP_BD2A.D_Minute_area_std(m_tensor_x, OP_BA2D.Mmask_day_plus(m_tensor_y,
                                                                                      OP_BD2A.D_Minute_area_mean(
                                                                                          m_tensor_y, mask))),
        OP_BD2A.D_Minute_area_std(m_tensor_x,
                                  OP_BA2D.Mmask_day_sub(m_tensor_y, OP_BD2A.D_Minute_area_mean(m_tensor_y, mask))))
        pass
