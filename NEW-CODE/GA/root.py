...
class MP_Root:
    def __init__(self, MP_Seed: [str], population_size=10):
        ...
        self.OP_A2A_func_list = ['D_cs_rank', 'D_cs_scale', 'D_cs_zscore', 'D_cs_harmonic_mean', 'D_cs_demean', 'D_cs_winsor']
        ...
        self.OP_B2B_func_list = ['M_cs_rank', 'M_cs_scale', 'M_cs_zscore', 'M_cs_demean', 'M_cs_winsor', 'M_at_abs', 'M_ts_pctchg']
        self.OP_BB2B_func_list = ['M_at_add', 'M_at_sub', 'M_at_div', 'M_at_sign', 'M_cs_cut', 'M_cs_umr', 'M_at_prod', 'M_cs_norm_spread']
        self.OP_BA2B_func_list = ['M_toD_standard']
        self.OP_BG2B_func_list = ['M_cs_edge_flip']
        self.OP_BF2B_func_list = ['M_ts_delta', 'M_ts_mean_left_neighbor', 'M_ts_mean_mid_neighbor', 'M_ts_mean_right_neighbor', 'M_ts_std_left_neighbor', 'M_ts_std_mid_neighbor', 'M_ts_std_right_neighbor', 'M_ts_product_left_neighbor', 'M_ts_product_mid_neighbor', 'M_ts_product_right_neighbor']
