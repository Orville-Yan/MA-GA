...
class Trunk:
    def __init__(self, industry_used,input1: list[str], input2, input3,population_size=100):
        self.input1 = input1
        self.input2 = input2
        self.input3 = input3
    ...
    def generate_toolbox(self):
        self.pset = gp.PrimitiveSetTyped("MAIN", [TypeB] * len(self.input1)+ [TypeA]*len(self.input2)+ [TypeD]*len(self.input3), TypeB)
    ...
    def generate_Trunk(self):
        ...
        self.individuals_code, self.individuals_str = change_name(self.individuals_code, self.input1+self.input2+self.input3)
...
if __name__ == '__main__':
    ...
    mp_trunk = Trunk(industry_used,M_Root,op_A,op_D)
